...
#if !defined(NO_82541_SUPPORT) || !defined(NO_82575_SUPPORT)
/**
 ...
 **/
s32 e1000_read_nvm_spi(struct e1000_hw *hw, u16 offset, u16 words, /* kdnet */ __out_ecount(words) u16 *data)
{
	struct e1000_nvm_info *nvm = &hw->nvm;
	u32 i = 0;
	s32 ret_val;
 ...
 **/
s32 e1000_read_nvm_eerd(struct e1000_hw *hw, u16 offset, u16 words, /* kdnet */ __out_ecount(words) u16 *data)
{
	struct e1000_nvm_info *nvm = &hw->nvm;
	u32 i, eerd = 0;
